...
<div style="display:flex;flex-direction:column;gap:60px">
    <img src="./screenshots/shot01.png" width=100% height=700 />
    <img src="./screenshots/shot02.png" width=100% height=700 />
    <img src="./screenshots/shot03.png" width=100% height=700 />
</div>
...
- [x] Explore the predefined list of icons
- [x] Change the application icon
- [ ] Add new icons

See the [open issues](https://github.com/HelioPC/Hike/issues) for a full list of proposed features (and known issues).
